...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { description: @concert.description, name: @concert.name, picture: @concert.picture } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { description: @concert.description, name: @concert.name, picture: @concert.picture } }
